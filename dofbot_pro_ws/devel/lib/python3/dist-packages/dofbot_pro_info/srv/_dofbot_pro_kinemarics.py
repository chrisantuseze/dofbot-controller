...
"""autogenerated by genpy from dofbot_pro_info/dofbot_pro_kinemaricsRequest.msg. Do not edit."""
import codecs
import sys
...
class dofbot_pro_kinemaricsRequest(genpy.Message):
  _md5sum = "11d857e8542c0047afc9d3b13061446f"
  _type = "dofbot_pro_info/dofbot_pro_kinemaricsRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(dofbot_pro_kinemaricsRequest, self).__init__(*args, **kwds)
...
def _get_struct_12d():
    ...
    return _struct_12d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from dofbot_pro_info/dofbot_pro_kinemaricsResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class dofbot_pro_kinemaricsResponse(genpy.Message):
  _md5sum = "906df963bc5a51f2145b13de1507f439"
  _type = "dofbot_pro_info/dofbot_pro_kinemaricsResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# response
float64 joint1
float64 joint2
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(dofbot_pro_kinemaricsResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_12d():
    ...
    if _struct_12d is None:
        _struct_12d = struct.Struct("<12d")
    return _struct_12d
class dofbot_pro_kinemarics(object):
  _type          = 'dofbot_pro_info/dofbot_pro_kinemarics'
  _md5sum = 'd4d7066ccc45dfff67e7b0b528d14e9b'
  _request_class  = dofbot_pro_kinemaricsRequest
  _response_class = dofbot_pro_kinemaricsResponse
