...
"""autogenerated by genpy from yahboomcar_msgs/Yolov5Detect.msg. Do not edit."""
import codecs
import sys
...
class Yolov5Detect(genpy.Message):
  _md5sum = "f6fde05b13d0b4d8a4f931c44fa3dda6"
  _type = "yahboomcar_msgs/Yolov5Detect"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string result
float32 centerx
float32 centery"""
  __slots__ = ['result','centerx','centery']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Yolov5Detect, self).__init__(*args, **kwds)
