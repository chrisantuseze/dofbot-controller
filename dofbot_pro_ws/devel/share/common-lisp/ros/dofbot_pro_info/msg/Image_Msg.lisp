...
(cl:defmethod cl:initialize-instance :after ((m <Image_Msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Image_Msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dofbot_pro_info-msg:<Image_Msg> is deprecated: use dofbot_pro_info-msg:Image_Msg instead.")))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <Image_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dofbot_pro_info-msg:height-val is deprecated.  Use dofbot_pro_info-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Image_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dofbot_pro_info-msg:width-val is deprecated.  Use dofbot_pro_info-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'channels-val :lambda-list '(m))
(cl:defmethod channels-val ((m <Image_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dofbot_pro_info-msg:channels-val is deprecated.  Use dofbot_pro_info-msg:channels instead.")
  (channels m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Image_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dofbot_pro_info-msg:data-val is deprecated.  Use dofbot_pro_info-msg:data instead.")
  (data m))
