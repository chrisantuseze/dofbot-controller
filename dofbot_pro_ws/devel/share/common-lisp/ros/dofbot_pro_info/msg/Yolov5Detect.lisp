...
(cl:defmethod cl:initialize-instance :after ((m <Yolov5Detect>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Yolov5Detect)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dofbot_pro_info-msg:<Yolov5Detect> is deprecated: use dofbot_pro_info-msg:Yolov5Detect instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Yolov5Detect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dofbot_pro_info-msg:result-val is deprecated.  Use dofbot_pro_info-msg:result instead.")
  (result m))

(cl:ensure-generic-function 'centerx-val :lambda-list '(m))
(cl:defmethod centerx-val ((m <Yolov5Detect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dofbot_pro_info-msg:centerx-val is deprecated.  Use dofbot_pro_info-msg:centerx instead.")
  (centerx m))

(cl:ensure-generic-function 'centery-val :lambda-list '(m))
(cl:defmethod centery-val ((m <Yolov5Detect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dofbot_pro_info-msg:centery-val is deprecated.  Use dofbot_pro_info-msg:centery instead.")
  (centery m))
