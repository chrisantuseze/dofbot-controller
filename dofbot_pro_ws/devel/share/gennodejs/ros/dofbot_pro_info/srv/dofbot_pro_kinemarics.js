...
class dofbot_pro_kinemaricsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type dofbot_pro_kinemaricsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type dofbot_pro_kinemaricsRequest
    let len;
    let data = new dofbot_pro_kinemaricsRequest(null);
  ...
  static datatype() {
    ...
    return 'dofbot_pro_info/dofbot_pro_kinemaricsRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new dofbot_pro_kinemaricsRequest(null);
...
class dofbot_pro_kinemaricsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.joint1 = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type dofbot_pro_kinemaricsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type dofbot_pro_kinemaricsResponse
    let len;
    let data = new dofbot_pro_kinemaricsResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'dofbot_pro_info/dofbot_pro_kinemaricsResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new dofbot_pro_kinemaricsResponse(null);
...
module.exports = {
  ...
  Response: dofbot_pro_kinemaricsResponse,
  md5sum() { return 'd4d7066ccc45dfff67e7b0b528d14e9b'; },
  datatype() { return 'dofbot_pro_info/dofbot_pro_kinemarics'; }
};
