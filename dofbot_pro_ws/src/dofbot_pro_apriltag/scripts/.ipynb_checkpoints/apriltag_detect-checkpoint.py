...
class AprilTagDetectNode:
    def __init__(self):
        ...
        self.pos_info_pub = rospy.Publisher("PosInfo",AprilTagInfo,queue_size=1)
    ...
    def TagDetect(self,color_frame,depth_frame):
        ...
        depth_to_color_image = cv.applyColorMap(cv.convertScaleAbs(depth_image, alpha=0.03), cv.COLORMAP_JET)
