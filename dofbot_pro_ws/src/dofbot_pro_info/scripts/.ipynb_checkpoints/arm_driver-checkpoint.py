...
if __name__ == '__main__':
	...
	#Arm.Arm_serial_servo_write6(177.0, 52.0, 48.0, 0.0, 83.0, 30.0, 1000) #gripper_adjust
	#Arm.Arm_serial_servo_write6(179.0, 130.0, 0.0, 14.0, 99.0, 30.0, 1000) #height_detect
    #Arm.Arm_serial_servo_write6(110.0, 1.0, 90.0, 90.0, 90.0, 30.0, 1000) #height_detect
    #time.sleep(5)   
    #arm_driver.Arm.Arm_serial_servo_write6(90.0, 180.0, 0.0, 0.0, 90.0, 30.0, 5000) #height_detect
    arm_driver.Arm.Arm_serial_servo_write6(90.0, 90.0, 90.0, 0.0, 90.0, 30.0, 3000)
    #arm_driver.pub_cur_joints()
    #arm_driver.joints_states_update()
    #arm_driver.Arm.Arm_serial_servo_write6(88.0, 4.0,90.0, 90, 90.0, 90.0, 5000)
    rospy.spin()
