...
class TagGraspNode:
    def __init__(self):
        ...
        self.tag_info_sub = rospy.Subscriber("PosInfo", AprilTagInfo, self.pos_info_callback, queue_size=1)
        ...
        self.down_joint = [10.0, 70.0, 34.0, 16.0, 90.0,140]
...
if __name__ == '__main__':
    try:
        ...
        tag_grasp.pubArm([90.0, 120, 0.0, 0.0, 90, 30])
        rospy.spin()
