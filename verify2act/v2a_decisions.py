"""
verify2act/v2a_decisions.py
===========================
Critic gating logic, copied unchanged from the Verify2Act research repo
(verify2act/critic/inference.py, branch main-wm) so the robot pipeline makes the same
continue / requery / reflect decisions as the simulation experiments.
Defaults from the repo's run_episode(): theta_c=0.5, theta_p=0.6, confidence_threshold=0.08.
"""
